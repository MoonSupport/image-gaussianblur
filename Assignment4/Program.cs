...
namespace Assignment4
{
    public sealed class Program
    {
        public static void Main(string[] args)
        {
            ...
            filter1D = new double[] { 0, 1, 0 };

            result1D = SignalProcessor.Convolve1D(signal, filter1D);

            assertArrayEqual(new double[] { 10, 50, 60, 10, 20, 40, 30 }, result1D, double.Epsilon);
            ...
            assertArrayEqual(new double[] {  50, 60, 10, 20, 40, 30, 0 }, result1D, double.Epsilon);
            ...
            assertArrayEqual(new double[] { 0, 10, 50, 60, 10, 20, 40 }, result1D, double.Epsilon);
            ...
            {
                Color img1 = image.GetPixel(0, 2);
                Color img2 = image.GetPixel(0, 3);
                Color img3 = image.GetPixel(0, 4);
                Color img4 = image.GetPixel(1, 2);
                Color img5 = image.GetPixel(1, 3);
                Color img6 = image.GetPixel(1, 4);

                Color nImage1 = newImage.GetPixel(0, 3);
                Color eImage1 = expected.GetPixel(0,3);
